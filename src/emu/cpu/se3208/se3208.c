...
static void SE3208_Init(int index, int clock, const void *config, int (*irqcallback)(int))
{
	...
	state_save_register_item_array("SE3208", index, Context.R);
	state_save_register_item("SE3208", index, Context.PC);
	state_save_register_item("SE3208", index, Context.SR);
	state_save_register_item("SE3208", index, Context.SP);
	state_save_register_item("SE3208", index, Context.ER);
	state_save_register_item("SE3208", index, Context.PPC);
	state_save_register_item("SE3208", index, Context.IRQ);
	state_save_register_item("SE3208", index, Context.NMI);
