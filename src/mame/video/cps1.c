...
static struct CPS1config cps1_config_table[]=
{
...
#ifdef KAILLERA
	{"captcomm3p",BATTRY_3, 0,0,0, 0x0000,0xffff,0x0000,0xffff },
	{"captcomu3p",BATTRY_3, 0,0,0, 0x0000,0xffff,0x0000,0xffff },
	{"captcomj3p",BATTRY_3, 0,0,0, 0x0000,0xffff,0x0000,0xffff },
	{"captcomm4p",BATTRY_3, 0,0,0, 0x0000,0xffff,0x0000,0xffff },
	{"captcomu4p",BATTRY_3, 0,0,0, 0x0000,0xffff,0x0000,0xffff },
	{"captcomj4p",BATTRY_3, 0,0,0, 0x0000,0xffff,0x0000,0xffff },
#endif /* KAILLERA */
	...
	{"hsf2nb",  NOBATTRY, 4,4,0, 0x0000,0xffff,0x0000,0xffff, 9 },
	{0}		/* End of table */
};
...
{
	UINT16 mem = cps1_gfxram[region_switch_offset3 >> 1];
...
{                                                         \
    ...
    memory_install_read16_handler(0, ADDRESS_SPACE_PROGRAM, OFFSET, OFFSET+1, 0, 0, cps2_region_16_r); \
}
...
{                                                          \
    ...
    memory_install_read16_handler(0, ADDRESS_SPACE_PROGRAM, OFFSET, OFFSET+1, 0, 0, cps2_region_16_r2); \
}
...
{                                                          \
    ...
    memory_install_read16_handler(0, ADDRESS_SPACE_PROGRAM, OFFSET, OFFSET+1, 0, 0, cps2_region_16_r3); \
}
