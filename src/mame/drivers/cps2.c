...
static NVRAM_HANDLER( cps2 )
{
	...
	else if (!read_or_write)
	{
		...
		case NV_avspa3p:
			{
				UINT8 eeprom[] = {  0x00,0x01,0x00,0x01,0x01,0x00,0x01,0xc3,0x00,0X02,0x00,0x00,0x00,0x00,0x00,0x00,
				...
				EEPROM_set_data(eeprom, 128);  /* Set the EEPROM to Factory Defaults */
			}
			break;
		...
		case NV_batcirj4p:
			{
				UINT8 eeprom[] = {  0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
				...
				if(cps2_nvram_type == NV_batcir4p) {
		...
		case NV_ddsoma4p:
			{
				UINT8 eeprom[] = {  0x00,0x0b,0x01,0x00,0x01,0x01,0x00,0x02,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
				...
				if (cps2_nvram_type == NV_ddsomur1_4p) eeprom[0x63] = 0x01;
				if (cps2_nvram_type == NV_ddsom4p || cps2_nvram_type == NV_ddsomr2_4p)
				{
					...
					if (cps2_nvram_type == NV_ddsom4p) eeprom[0x63] = 0x01;
				}
				if (cps2_nvram_type == NV_ddsomjr1_4p || cps2_nvram_type == NV_ddsomj4p)
				{
					...
					if (cps2_nvram_type == NV_ddsomj4p) eeprom[0x63] = 0x01;
				}
				if (cps2_nvram_type == NV_ddsoma4p)
				{
					eeprom[0x23] = eeprom[0x53] = 0x06;
		...
		case NV_sfz3ar1p:
			{
				UINT8 eeprom[] = {  0x00,0x01,0x00,0x01,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
		...
		case NV_hsf2anb:
			{
				UINT8 eeprom[] = {  0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
									...
									0x03,0x00,0x00,0x01,0x01,0x01,0x00,0x00,0x04,0x02,0x02,0x41,0x48,0x53,0x46,0x4A,
									0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
									0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x04,0x00,
									0x03,0x00,0x00,0x01,0x01,0x01,0x00,0x00,0x04,0x02,0x02,0x41,0x48,0x53,0x46,0x4A,
									0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
...
GAME( 2004, hsf2nb,   hsf2,    cps2,    ssf2,    cps2, ROT0,   "hack", "Hyper Street Fighter II: The Anniversary Edition (Asia 040202 Phoenix Edition / Nebula set)", 0 )

#ifdef KAILLERA
GAME_HACK( 1998, sfa3p,          sfa3,     cps2, ssf2,    cps2, ROT0,   "Capcom", "Street Fighter Alpha 3 (Euro 980904 / Battle Modes Unlocked)", 0 )
GAME_HACK( 1998, sfa3up,         sfa3u,    cps2, ssf2,    cps2, ROT0,   "Capcom", "Street Fighter Alpha 3 (USA 980904 / Battle Modes Unlocked)", 0 )
GAME_HACK( 1998, sfa3ur1p,       sfa3ur1,  cps2, ssf2,    cps2, ROT0,   "Capcom", "Street Fighter Alpha 3 (USA 980629 / Battle Modes Unlocked)", 0 )
GAME_HACK( 1998, sfz3jp,         sfz3j,    cps2, ssf2,    cps2, ROT0,   "Capcom", "Street Fighter Zero 3 (Japan 980904 / Battle Modes Unlocked)", 0 )
GAME_HACK( 1998, sfz3jr1p,       sfz3jr1,  cps2, ssf2,    cps2, ROT0,   "Capcom", "Street Fighter Zero 3 (Japan 980727 / Battle Modes Unlocked)", 0 )
GAME_HACK( 1998, sfz3jr2p,       sfz3jr2,  cps2, ssf2,    cps2, ROT0,   "Capcom", "Street Fighter Zero 3 (Japan 980629 / Battle Modes Unlocked)", 0 )
GAME_HACK( 1998, sfz3ar1p,       sfz3ar1,  cps2, ssf2,    cps2, ROT0,   "Capcom", "Street Fighter Zero 3 (Asia 980701 / Battle Modes Unlocked)", 0 )

GAME_HACK (1994, avsp3p,         avsp,     cps2, avsp,    cps2, ROT0,   "Capcom", "Alien vs. Predator (Euro 940520 / 3 Players for kaillera)", 0 )
GAME_HACK( 1994, avspu3p,        avspu,    cps2, avsp,    cps2, ROT0,   "Capcom", "Alien vs. Predator (US 940520 / 3 Players for kaillera)", 0 )
GAME_HACK( 1994, avspj3p,        avspj,    cps2, avsp,    cps2, ROT0,   "Capcom", "Alien vs. Predator (Japan 940520 / 3 Players for kaillera)", 0 )
GAME_HACK( 1994, avspa3p,        avspa,    cps2, avsp,    cps2, ROT0,   "Capcom", "Alien vs. Predator (Asia 940520 / 3 Players for kaillera)", 0 )
GAME_HACK( 1997, batcir4p,       batcir,   cps2, batcir,  cps2, ROT0,   "Capcom", "Battle Circuit (Euro 970319 / 4 Players for kaillera)", 0 )
GAME_HACK( 1997, batcirj4p,      batcirj,  cps2, batcir,  cps2, ROT0,   "Capcom", "Battle Circuit (Japan 970319 / 4 Players for kaillera)", 0 )
GAME_HACK( 1996, ddsom4p,        ddsom,    cps2, ddtod,   cps2, ROT0,   "Capcom", "Dungeons & Dragons: Shadow over Mystara (Euro 960619 / 4 Players for kaillera)", 0 )
GAME_HACK( 1996, ddsomr2_4p,     ddsomr2,  cps2, ddtod,   cps2, ROT0,   "Capcom", "Dungeons & Dragons: Shadow over Mystara (Euro 960209 / 4 Players for kaillera)", 0 )
GAME_HACK( 1996, ddsomu4p,       ddsomu,   cps2, ddtod,   cps2, ROT0,   "Capcom", "Dungeons & Dragons: Shadow over Mystara (US 960619 / 4 Players for kaillera)", 0 )
GAME_HACK( 1996, ddsomur1_4p,    ddsomur1, cps2, ddtod,   cps2, ROT0,   "Capcom", "Dungeons & Dragons: Shadow over Mystara (US 960209 / 4 Players for kaillera)", 0 )
GAME_HACK( 1996, ddsomj4p,       ddsomj,   cps2, ddtod,   cps2, ROT0,   "Capcom", "Dungeons & Dragons: Shadow over Mystara (Japan 960619 / 4 Players for kaillera)", 0 )
GAME_HACK( 1996, ddsomjr1_4p,    ddsomjr1, cps2, ddtod,   cps2, ROT0,   "Capcom", "Dungeons & Dragons: Shadow over Mystara (Japan 960206 / 4 Players for kaillera)", 0 )
GAME_HACK( 1996, ddsoma4p,       ddsoma,   cps2, ddtod,   cps2, ROT0,   "Capcom", "Dungeons & Dragons: Shadow over Mystara (Asia 960619 / 4 Players for kaillera)", 0 )

#ifdef MAME32PLUSPLUS
GAME_HACK( 1996, xmvsfregion4p,  xmvsfu,   cps2, ssf2,    cps2, ROT0,   "Capcom", "X-Men Vs. Street Fighter (4 Players for kaillera)", 0 )
#endif /* MAME32PLUSPLUS */
GAME_HACK( 1997, mshvsfj4p,      mshvsfj,  cps2, ssf2,    cps2, ROT0,   "Capcom", "Marvel Super Heroes Vs. Street Fighter (Japan 970707 / 4 Players for kaillera)", 0 )
GAME_HACK( 1998, mvscj4p,        mvscj,    cps2, ssf2,    cps2, ROT0,   "Capcom", "Marvel Vs. Capcom: Clash of Super Heroes (Japan 980123 / 4 Players for kaillera)", 0 )
#endif /* KAILLERA */
