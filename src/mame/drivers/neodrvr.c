...
ROM_START( ssh5spnd )
	...
	ROM_REGION( 0x4000000, NEOGEO_REGION_SPRITES, 0 )/* Not Encrypted */
...
#ifdef MAME32PLUSPLUS
/* Yuki Enterprise */
GAMEB( 2004, ssh5spnd, samsh5sp, neogeo, neogeo, neogeo,  neogeo,   ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V Special / Samurai Spirits Zero Special (non encrypted P, decrypted C)", 0 )
#endif /* MAME32PLUSPLUS */

/* SNK */
#ifdef KAILLERA
GAMEB_HACK( 1990, lbowling4p, lbowling,   neogeo, neogeo, neogeo,  neogeo,   ROT0, "SNK", "League Bowling (4 Players for kaillera)", 0 )
GAMEB_HACK( 1995, kof95_6p,   kof95,      neogeo, neogeo, neogeo,  neogeo,   ROT0, "SNK", "The King of Fighters '95 (6 Players for kaillera)", 0 )
GAMEB_HACK( 1998, kof98_6p,   kof98,      neogeo, neogeo, neogeo,  kof98,    ROT0, "SNK", "The King of Fighters '98 (6 Players for kaillera)", 0 )
#endif /* KAILLERA */
