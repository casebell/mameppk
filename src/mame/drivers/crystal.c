...
static void crystal_set_cpu_bank(void)
{
	if(Bank<=2)
		memory_set_bankptr(1,memory_region(REGION_USER1)+Bank*0x1000000);
	else
...
{
	state_save_register_item("crystal", 0, Bank);
	state_save_register_item("crystal", 0, FlipCount);
	state_save_register_item("crystal", 0, IntHigh);
	state_save_register_item("crystal", 0, Timer0ctrl);
	state_save_register_item("crystal", 0, Timer1ctrl);
	state_save_register_item("crystal", 0, Timer2ctrl);
	state_save_register_item("crystal", 0, Timer3ctrl);
	state_save_register_item("crystal", 0, FlashCmd);
	state_save_register_item("crystal", 0, PIO);
	state_save_register_item("crystal", 0, DMA0ctrl);
	state_save_register_item("crystal", 0, DMA1ctrl);
	state_save_register_item("crystal", 0, OldPort4);
#ifdef IDLE_LOOP_SPEEDUP
	state_save_register_item("crystal", 0, FlipCntRead);
#endif

	state_save_register_func_postload(crystal_set_cpu_bank);
}
