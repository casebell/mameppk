...
{
#ifdef KAILLERA
	int nvram_type = NV_NORMAL;

	if (!strcmp(Machine->gamedrv->name, "arabianm4p"))	nvram_type = NV_arabianm4p;
	if (!strcmp(Machine->gamedrv->name, "arabiamj4p"))	nvram_type = NV_arabiamj4p;
	if (!strcmp(Machine->gamedrv->name, "arabiamu4p"))	nvram_type = NV_arabiamu4p;
	if (!strcmp(Machine->gamedrv->name, "dungeonm4p"))	nvram_type = NV_dungeonm4p;
	if (!strcmp(Machine->gamedrv->name, "lightbr4p"))	nvram_type = NV_lightbr4p;
	if (!strcmp(Machine->gamedrv->name, "dungenmu4p"))	nvram_type = NV_dungenmu4p;

	if (nvram_type == NV_NORMAL)
	{
		if (read_or_write)
			EEPROM_save(file);
		else
	...
	else if (!read_or_write)
	{
		...
		case NV_arabiamu4p:
			{
				static UINT8 eeprom[] = {
					0x54,0x41,0x49,0x54,0x4f,0x01,0x43,0x4b,0x37,0x4f,0xe0,0x0d,0x11,0x11,0x1f,0x00,
					0x00,0x00,0x01,0x00,0xff,0xf5,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x87,0xbd,
					0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,
					0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,
					0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,
					0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,
		...
		case NV_dungenmu4p:
			{
				static UINT8 eeprom[] = {
					0x54,0x41,0x49,0x54,0x4f,0x01,0x43,0x50,0x33,0x4f,0xe0,0x21,0x11,0x11,0x30,0x00,
					0x00,0x00,0x02,0x01,0xff,0xf7,0x22,0x12,0x00,0x00,0x00,0x00,0x00,0x00,0x57,0x8f,
					0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,
					0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,
					0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,
					0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,
...
#ifdef KAILLERA
GAME_HACK( 1992, arabianm4p, arabianm, f3_224a, f3, arabianm, ROT0,   "Taito Corporation Japan",   "Arabian Magic (World / 4 Players for kaillera)", 0 )
GAME_HACK( 1992, arabiamj4p, arabiamj, f3_224a, f3, arabianm, ROT0,   "Taito Corporation",         "Arabian Magic (Japan / 4 Players for kaillera)", 0 )
GAME_HACK( 1992, arabiamu4p, arabiamu, f3_224a, f3, arabianm, ROT0,   "Taito America Corporation", "Arabian Magic (US / 4 Players for kaillera)", 0 )
GAME_HACK( 1993, dungeonm4p, dungeonm, f3_224a, f3, lightbr,  ROT0,   "Taito Corporation Japan",   "Dungeon Magic (World / 4 Players for kaillera)", 0 )
GAME_HACK( 1993, lightbr4p,  lightbr,  f3_224a, f3, lightbr,  ROT0,   "Taito Corporation",         "Light Bringer (Japan / 4 Players for kaillera)", 0 )
GAME_HACK( 1993, dungenmu4p, dungenmu, f3_224a, f3, lightbr,  ROT0,   "Taito America Corporation", "Dungeon Magic (US / 4 Players for kaillera)", 0 )
#endif /* KAILERA */
