...
static DRIVER_INIT( ga2j4p )
{
	...
	segas32_common_init(extra_custom_io_r, NULL, ga2j4p_default_eeprom);
...
#ifdef KAILLERA
GAME_HACK( 1992, ga2j4p,   ga2j,     system32, ga2u,     ga2j4p,   ROT0, "Sega",   "Golden Axe: The Revenge of Death Adder (Japan / 4 Players for kaillera)", GAME_IMPERFECT_GRAPHICS )
#endif /* KAILLERA */
