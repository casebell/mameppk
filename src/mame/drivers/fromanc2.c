...
static INTERRUPT_GEN( fromanc2_k_interrupt )
{
	...
	if(!kPlay)
	{
		if (input_code_pressed(KEYCODE_F1)) {
			if (key_F1_old != 1) {
				key_F1_old = 1;
...
static MACHINE_DRIVER_START( fromanc2_k )
	...
	MDRV_CPU_ADD(M68000,32000000/2)		/* 16.00 MHz */
	MDRV_CPU_PROGRAM_MAP(fromanc2_readmem_main,fromanc2_writemem_main)
	MDRV_CPU_VBLANK_INT(fromanc2_k_interrupt,1)
...
#ifdef KAILLERA
GAME_HACK( 1995, fromanc2_k, fromanc2, fromanc2_k, fromanc2, fromanc2, ROT0, "Video System Co.", "Taisen Idol-Mahjong Final Romance 2 (Japan / kaillera)", 0 )
GAME_HACK( 1995, fromancr_k, fromancr, fromancr_k, fromanc2, fromancr, ROT0, "Video System Co.", "Taisen Mahjong FinalRomance R (Japan / kaillera)", 0 )
GAME_HACK( 1998, fromanc4_k, fromanc4, fromanc4_k, fromanc4, fromanc4, ROT0, "Video System Co.", "Taisen Mahjong FinalRomance 4 (Japan / kaillera)", 0 )
#endif /* KAILLERA */
