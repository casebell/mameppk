...
# kaillera
ifdef KAILLERA
XEXTRA_SUFFIX = $(EXTRA_SUFFIX)k$(XXEXTRA_SUFFIX)
else
XEXTRA_SUFFIX = $(EXTRA_SUFFIX)$(XXEXTRA_SUFFIX)
endif
...
ifneq ($(MAME32PLUSPLUS),)
    DEFS += -DMAME32PLUSPLUS
endif
...
ifneq ($(EXPORT_GAME_LIST),)
	DEFS += -DEXPORT_GAME_LIST
endif
